<template>
    <div class="flex flex-col">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 overflow-auto shrink-0">
            <UBreadcrumb
                :links="[
                    { label: currentQuestion?.unit.topic.name, icon: 'i-tabler-folder', labelClass: 'text-gray-500 dark:text-gray-400', iconClass: 'text-gray-500 dark:text-gray-400' },
                    { label: currentQuestion?.unit.name, icon: 'i-tabler-color-swatch', labelClass: 'text-gray-500 dark:text-gray-400', iconClass: 'text-gray-500 dark:text-gray-400' }
                ]"
                class="min-w-fit"
            />
        </div>
