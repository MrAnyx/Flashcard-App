    ...
    <div class="h-full flex flex-col">
        ...
        <section class="p-6 grow flex flex-col items-center overflow-auto">
            <div class="flex items-center justify-between w-full">
                ...
                <UBreadcrumb
                    :links="[
                        { label: 'Tech', icon: 'i-tabler-folder', labelClass: 'text-gray-500 dark:text-gray-400', iconClass: 'text-gray-500 dark:text-gray-400 hidden md:block' },
            ...
            <UCard class="max-w-2xl overflow-auto mt-6 sm:mt-10 min-h-[80px]">
                <template #header>
                    <div class="flex justify-between items-center">
                        <UTooltip text="Search on Google for more details">
                            <UIcon name="i-tabler-mood-puzzled" class="w-5 h-5 text-gray-400 hover:text-gray-200" />
                        </UTooltip>

                        <UTooltip text="Difficulty of 6/10">
                ...
                <p class="leading-8 sm:leading-10 text-lg sm:text-xl">
